 ...
 */
export type Sqlite3ConnectionsTreeNode =
	| MySqlConnectionTreeNode
	| Sqlite3TableTreeNode;
 ...
 */
export class Sqlite3ConnectionsTreeDataProvider
	implements vscode.TreeDataProvider<Sqlite3ConnectionsTreeNode>
{
	...
	private readonly onDidChangeTreeDataEmitter =
		new vscode.EventEmitter<Sqlite3ConnectionsTreeNode | undefined>();
	...
	public getTreeItem(element: Sqlite3ConnectionsTreeNode): vscode.TreeItem {
		if (element.kind === 'connection') {
			...
			treeItem.contextValue =
				Sqlite3ConnectionsTreeDataProvider.connectionContextValue;
			treeItem.description =
				element.connection.engine === 'sqlite3'
					? element.connection.dbPath
					: undefined;
