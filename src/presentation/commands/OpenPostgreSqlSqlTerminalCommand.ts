...
export class OpenPostgreSqlSqlTerminalCommand implements ExtensionCommand {
   ...
   */
  public constructor(private readonly postgreSqlSqlTerminalPanel: PostgreSqlSqlTerminalPanel) {}
  ...
  private resolveInitialTarget(node?: DatabaseConnectionsTreeNode):
    ...
    if (node.kind === "connection") {
      return node.connection.engine === "postgresql" ? { connection: node.connection } : undefined;
    }
