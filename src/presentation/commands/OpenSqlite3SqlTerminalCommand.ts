...
export class OpenSqlite3SqlTerminalCommand implements ExtensionCommand {
	 ...
	 */
	public constructor(
		private readonly sqlite3SqlTerminalPanel: Sqlite3SqlTerminalPanel
	) {}
	...
	public register(): vscode.Disposable {
		return vscode.commands.registerCommand(
			...
			async (node?: MySqlConnectionsTreeNode, initialSql?: string) => {
				await this.sqlite3SqlTerminalPanel.open(
	 ...
	 *
	 * @param node 可选的数据库 Tree 节点。
	 * @returns 初始选中的 SQLite3 连接。
	 */
