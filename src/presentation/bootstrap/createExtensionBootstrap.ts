...
export function createExtensionBootstrap(context: vscode.ExtensionContext): ExtensionBootstrap {
  ...
  const mySqlConnectionsTreeDataProvider = new MySqlConnectionsTreeDataProvider(
  ...
  return new ExtensionBootstrap(
    [
      ...
      new TestStoredMySqlConnectionCommand(listStoredConnectionsUseCase, testConnectionUseCase),
