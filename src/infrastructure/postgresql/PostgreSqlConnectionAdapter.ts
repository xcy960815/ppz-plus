...
export class PostgreSqlConnectionAdapter {
	 ...
	 *
	 * @param connectionUrl 用户保存的 PostgreSQL 连接 URL。
	 * @param databaseName 需要连接的 database。
	 * @returns 替换 database 后的连接 URL。
	 */
	private replaceDatabaseName(
