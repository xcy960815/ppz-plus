 ...
 */
export class GlobalStateSqlExportTaskLogRepository implements SqlExportTaskLogRepository {
  /**
  ...
  public async append(entry: SqlExportTaskLogEntry): Promise<void> {
    ...
    await this.globalState.update(GlobalStateSqlExportTaskLogRepository.storageKey, nextEntries);
  }
  ...
  public async clear(): Promise<void> {
    await this.globalState.update(GlobalStateSqlExportTaskLogRepository.storageKey, []);
  }
