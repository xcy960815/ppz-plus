...
export class ExecutePostgreSqlSqlUseCase {
   ...
   */
  public constructor(private readonly postgreSqlSqlExecutor: PostgreSqlSqlExecutor) {}
  ...
  public async execute(
    ...
    const normalizedDatabaseName =
      databaseName && databaseName.trim().length > 0 ? databaseName.trim() : undefined;
    ...
    return this.postgreSqlSqlExecutor.executeSql(connection, normalizedDatabaseName, normalizedSql);
  }
}
