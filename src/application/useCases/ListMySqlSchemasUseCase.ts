...
import type { MySqlMetadataProvider, MySqlSchemaMetadata } from "../mysql/MySqlMetadataProvider";
...
export class ListMySqlSchemasUseCase {
   ...
   */
  public async execute(connection: MysqlConnectionConfig): Promise<readonly MySqlSchemaMetadata[]> {
