...
export class RecordSqlExportTaskLogUseCase {
   ...
   */
  public constructor(private readonly sqlExportTaskLogRepository: SqlExportTaskLogRepository) {}
   ...
   */
  public async execute(input: SqlExportTaskLogInput): Promise<SqlExportTaskLogEntry> {
    const entry = {
      id: randomUUID(),
      ...input,
    };
