...
export class CheckSqlExportCapabilityUseCase {
   ...
   */
  public constructor(private readonly capabilityCatalog: DatabaseCapabilityCatalog) {}
   ...
   */
  public execute(engine: DatabaseEngine, kind: SqlExportKind): SqlExportCapabilityCheck {
    // 获取当前导出类型要求的能力键。
   ...
   */
  private resolveRequiredCapabilityKeys(kind: SqlExportKind): readonly DatabaseCapabilityKey[] {
    if (kind === "ddl") {
      return ["exportDdl"];
    }
