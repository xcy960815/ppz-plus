...
export class ListPostgreSqlTablesUseCase {
   ...
   */
  public constructor(private readonly postgreSqlMetadataProvider: PostgreSqlMetadataProvider) {}
  ...
  public async execute(
    ...
    return this.postgreSqlMetadataProvider.listTables(connection, databaseName, schemaName);
  }
}
