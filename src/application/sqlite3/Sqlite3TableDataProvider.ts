 ...
 * 描述新增单行记录时提交的字段值。
 */
export type Sqlite3TableInsertValues = Readonly<Record<string, Sqlite3TableInsertValue>>;

/**
 * 描述更新单行记录时定位原行的字段值。
 */
export type Sqlite3TableRowIdentityValues = Readonly<Record<string, Sqlite3TableCellValue>>;

/**
 * 描述更新单行记录时提交的新字段值。
 */
export type Sqlite3TableUpdateValues = Readonly<Record<string, Sqlite3TableCellValue>>;
