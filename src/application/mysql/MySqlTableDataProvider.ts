 ...
 * 描述新增单行记录时提交的字段值。
 */
export type MySqlTableInsertValues = Readonly<Record<string, MySqlTableInsertValue>>;

/**
 * 描述更新单行记录时定位原行的字段值。
 */
export type MySqlTableRowIdentityValues = Readonly<Record<string, MySqlTableCellValue>>;

/**
 * 描述更新单行记录时提交的新字段值。
 */
export type MySqlTableUpdateValues = Readonly<Record<string, MySqlTableCellValue>>;
